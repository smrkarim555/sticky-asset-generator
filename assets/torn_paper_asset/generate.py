...
def create_torn_paper(filename, color):
    ...
    ctx.move_to(200, 1000)
    ctx.line_to(3640, 1000)
    ctx.line_to(3640, 2000)
    
    # Generate torn edge
    x = 3640
    while x > 200:
        x -= 150
        y = 2000 + np.random.randint(-100, 100)
        ctx.curve_to(x + 75, 2000, x + 75, y, x, y)
        
    ctx.line_to(200, 2000)
    ctx.close_path()
    ctx.fill()
...
create_torn_paper('output_v1.png', (0.0, 0.2, 0.7))
create_torn_paper('output_v2.png', (0.8, 0.1, 0.1))
